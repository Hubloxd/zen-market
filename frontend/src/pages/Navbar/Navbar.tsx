...
const Cart = () => {
    ...
    return (
        ...
        <div className='ml-2 flex flex-col relative cursor-pointer w-12' >
                <svg fill="#FFF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 902.86 902.86" xmlSpace="preserve">
...
export default function Navbar(){
    return (
        ...
        <header className="h-20 flex flex-row justify-between bg-black text-white px-10">
            ...
            <div className="w-64">
                <Link to={'/'} className='flex flex-row items-center h-full text-center'>
            ...
            <div className="w-96 flex flex-row items-center justify-evenly">
                <svg className='w-5 mr-2' fill="#FFF" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.4 490.4" xmlSpace="preserve"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path d="M484.1,454.796l-110.5-110.6c29.8-36.3,47.6-82.8,47.6-133.4c0-116.3-94.3-210.6-210.6-210.6S0,94.496,0,210.796 s94.3,210.6,210.6,210.6c50.8,0,97.4-18,133.8-48l110.5,110.5c12.9,11.8,25,4.2,29.2,0C492.5,475.596,492.5,463.096,484.1,454.796z M41.1,210.796c0-93.6,75.9-169.5,169.5-169.5s169.6,75.9,169.6,169.5s-75.9,169.5-169.5,169.5S41.1,304.396,41.1,210.796z"></path> </g> </g>
                </svg>
                <SearchInput />
                <Link to={'/account'}>
                    <div className='w-12 flex flex-col items-center'>
                        <svg className='max-h-full' fill="#FFF" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" stroke="#FFF">
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
