...
export function RegisterForm(){
    ...
    return (
        <form id='login-form' method="post" onSubmit={handleSubmit} className="flex flex-col border w-96">
            <h1 className='text-center text-4xl font-light'>Zen Market</h1>
            <h1 className='text-center text-4xl my-10'>Register</h1>
            <input onChange={(e) => handleChange('username', e)} type="text" name="username" id="username" placeholder='username'/>
            <input onChange={(e) => handleChange('password', e)} type="password" name="password" id="password" placeholder='password'/>
            ...
            <div className="flex flex-row w-full justify-between mt-5 items-center">
                ...
                <button className='w-1/3 border rounded-lg py-2 transition-colors hover:bg-black hover:text-white' type="submit">Submit</button>
            </div>
        </form>
    );
};
